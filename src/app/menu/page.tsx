...
const menuItems: Record<string, { name: string; price: string; desc: string; image: string }[]> = {
    "Karahi": [
        {
            ...
            price: "£19.99 / £39.99",
            desc: "Butt Special — Organic Chicken. Small (½kg) £19.99 | Large (1kg) £39.99",
            image: IMG.karahi,
        },
        {
            name: "Charsi Chicken Karahi (Butter)",
            price: "£21.99 / £41.99",
            desc: "Rich buttery Charsi style chicken karahi. Small (½kg) £21.99 | Large (1kg) £41.99",
            image: IMG.karahi2,
        },
        {
            name: "Charsi Chicken Karahi",
            price: "£15.99 / £29.99",
            desc: "Classic Peshawari Charsi Chicken Karahi. Small (½kg) £15.99 | Large (1kg) £29.99",
            image: IMG.karahi,
        },
        {
            name: "Charsi Chicken Karahi (Butter)",
            price: "£16.99 / £31.99",
            desc: "Charsi Chicken Karahi with butter. Small (½kg) £16.99 | Large (1kg) £31.99",
            image: IMG.karahi2,
        },
        {
            name: "Lamb Karahi (Butt Special)",
            price: "£19.99 / £39.99",
            desc: "Premium Butt Special Lamb Karahi. Small (½kg) £19.99 | Large (1kg) £39.99",
            image: IMG.lambKarahi,
        },
        {
            name: "Lamb Karahi",
            price: "£21.99 / £41.99",
            desc: "Slow-cooked tender lamb in rich aromatic spices. Small (½kg) £21.99 | Large (1kg) £41.99",
            image: IMG.lambKarahi,
        },
        {
            name: "Charsi Lamb Karahi",
            price: "£17.99 / £35.99",
            desc: "Peshawari-style lamb karahi with minimal spices. Small (½kg) £17.99 | Large (1kg) £35.99",
            image: IMG.karahi,
        },
    ],
    "BBQ": [
        {
            name: "Charsi Tikka (Lamb / Chicken)",
            price: "£8.99 / £33.99",
            desc: "Succulent charsi-style tikka. Small £8.99 | Large £33.99",
            image: IMG.tikka,
        },
        {
            name: "Charsi Chops (Lamb)",
            price: "£16.99 / £33.99",
            desc: "Tender lamb chops marinated in charsi spices and grilled. Small £16.99 | Large £33.99",
            image: IMG.chops,
        },
        {
            name: "Mix Grill",
            price: "£29.99",
            desc: "With Fresh Salad & Afghan Naan. A hearty platter of assorted grilled meats.",
            image: IMG.mixGrill,
        },
        {
        ...
        },
        {
            ...
            price: "£14.99 / £29.99",
            desc: "Creamy, melt-in-your-mouth chicken malai botti. Small £14.99 | Large £29.99",
            image: IMG.tikka,
        },
        {
            name: "Seekh Kabab Portion (Lamb / Chicken)",
            price: "£3.99",
            desc: "Classic minced meat seekh kabab, grilled on skewers.",
        ...
        },
        {
            name: "French Fries",
            price: "£2.99",
            desc: "Crispy golden french fries, lightly seasoned.",
            image: IMG.fries,
        },
        {
            name: "Chicken Nuggets (8 Pcs) & Fries",
            price: "£5.99",
            desc: "8 pieces of crispy chicken nuggets served with french fries.",
            image: IMG.nuggets,
        },
        {
            name: "Finger Fish",
            price: "£11.99 / £21.99",
            desc: "Crispy fried fish fingers. Half kg £11.99 | 1 kg £21.99",
            image: IMG.fish,
        },
    ],
    "Butt Special Platter": [
    ...
    "Naan Special": [
        {
            name: "Peshawari Naan",
            price: "£1.49 / £2.99",
            desc: "Traditional Peshawari Naan. Small £1.49 | Large £2.99",
            image: IMG.naan,
        },
        {
            name: "Peshawari Roti",
            price: "£1.49 / £2.49",
            desc: "Classic whole-wheat Peshawari Roti. Small £1.49 | Large £2.49",
            image: IMG.naan,
        },
        {
            name: "Roghni Naan",
            price: "£2.49",
            desc: "Buttery, sesame-topped Roghni Naan baked in a tandoor.",
            image: IMG.naan,
        },
        {
            name: "Garlic Naan",
            price: "£2.49",
            desc: "Leavened naan topped with fresh garlic and butter.",
            image: IMG.naan,
        },
        {
            name: "Kalwangi Naan",
            price: "£2.49",
            desc: "Naan topped generously with nigella seeds (kalwangi).",
            image: IMG.naan,
        },
    ],
    "Rice Special": [
        {
            name: "Kabuli Pulao",
            price: "£9.99 / £11.99",
            desc: "Traditional Afghan rice with carrots and raisins. Small £9.99 | Large £11.99",
            image: IMG.pulao,
        },
        {
            name: "Kabuli Mahecha Pulao",
            price: "£7.99 / £9.99",
            desc: "Aromatic Kabuli pulao with a special Mahecha blend. Small £7.99 | Large £9.99",
            image: IMG.pulao,
        },
        {
            name: "Chicken Pulao",
    ...
    "Veg Special": [
        {
            name: "Special Daal Masha Fry",
            price: "£5.99 / £7.99",
            desc: "Black lentils tempered with aromatic spices. Small £5.99 | Large £7.99",
            image: IMG.daal,
        },
        {
            name: "Lobiya Dall",
            price: "£5.99 / £7.99",
            desc: "Black-eyed peas cooked in a rich spiced gravy. Small £5.99 | Large £7.99",
            image: IMG.daal,
        },
        {
            name: "Mix Vegetable",
            price: "£5.99 / £7.99",
            desc: "A hearty mix of seasonal vegetables cooked in desi spices. Small £5.99 | Large £7.99",
            image: IMG.vegMix,
        },
        {
            name: "Greek Salad",
    ...
    "Takatuk": [
        ...
        },
        {
            name: "Qeema Fry",
            price: "£12.99 / £25.99",
            desc: "Spiced minced meat dry-fried to perfection. Small £12.99 | Large £25.99",
            image: IMG.lambKarahi,
        },
        {
            name: "Seekh Kabab Karahi (Lamb / Chicken)",
            price: "£13.99 / £21.99",
            desc: "Seekh kabab pieces cooked in a karahi masala. Small £13.99 | Large £21.99",
            image: IMG.seekhKabab,
        },
        {
            name: "Special Daal Ghost Karahi",
            price: "£11.99 / £19.99",
            desc: "Lamb meat slow-cooked with lentils in a karahi. Small £11.99 | Large £19.99",
            image: IMG.daal,
        },
    ],
    "Chapli Kabab": [
